...
export function BacktestResultsTable({ backtestResults }: BacktestResultsTableProps) {
  ...
  const columns: ColumnDef<BacktestListItem>[] = [
    {
      accessorKey: "symbol",
      header: "Symbol",
    },
    ...
    },
    {
      ...
      header: "Start Time",
      cell: ({ row }) => formatDate(row.getValue("start_timestamp")),
    },
    {
      accessorKey: "end_timestamp",
      header: "End Time",
      cell: ({ row }) => formatDate(row.getValue("end_timestamp")),
    },
    {
      ...
      cell: ({ row }) => {
        const amount = parseFloat(row.getValue("total_return_pct"))
        return (
    ...
    },
    {
      ...
      cell: ({ row }) => {
        const amount = parseFloat(row.getValue("sharpe_ratio"))
    ...
    },
    {
      ...
      cell: ({ row }) => {
        const amount = parseFloat(row.getValue("win_rate_pct"))
        return <div className="font-medium">{amount.toFixed(1)}%</div>
      },
    },
    {
